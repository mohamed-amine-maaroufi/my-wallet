...
*/
        ...
        entriesincome.add(new PieEntry((float) abs(incomeforcash), "Espèce"));
        ...
        entriesincome.add(new PieEntry((float) abs(incomeforotheraccounts), "Autre"));
...
/*          pieincomeaccount.addItem("Espèce", abs(incomeforcash), res.getColor(R.color.colorPrimaryDark));
            pieincomeaccount.addItem("Carte de crédit", abs(incomeforcreditcard), res.getColor(R.color.colorAccent));
            pieincomeaccount.addItem("Carte de débit", abs(incomefordebitcard), res.getColor(R.color.fab1_color));
            pieincomeaccount.addItem("Services de paiement en ligne", abs(incomeforonlinepaymentservices), res.getColor(R.color.fab2_color));
            pieincomeaccount.addItem("À crédit", abs(incomeforoncredit), res.getColor(R.color.blacktext));
            pieincomeaccount.addItem("Autre accounts", abs(incomeforotheraccounts), res.getColor(R.color.dark_green));
...
*/
        ...
        entriesincomecategory.add(new PieEntry((float) abs(incomeforsalary), "Salaire"));
        entriesincomecategory.add(new PieEntry((float) abs(incomeforrent), "Location"));
        entriesincomecategory.add(new PieEntry((float) abs(incomeforprofit), "Profit"));
        entriesincomecategory.add(new PieEntry((float) abs(incomeforpersonalsavings), "Épargne personnelle"));
        ...
        entriesincomecategory.add(new PieEntry((float) abs(incomeforoddjobs), "Petits boulots"));
        entriesincomecategory.add(new PieEntry((float) abs(incomeforwinnings), "Gains"));
        entriesincomecategory.add(new PieEntry((float) abs(incomeforothercategories), "Autre"));
...
/*        pieincomecategory.addItem("Salaire", abs(incomeforsalary), res.getColor(R.color.colorPrimaryDark));
        pieincomecategory.addItem("Location", abs(incomeforrent), res.getColor(R.color.colorAccent));
        ...
        pieincomecategory.addItem("Petits boulots", abs(incomeforoddjobs), res.getColor(R.color.dark_blue));
        pieincomecategory.addItem("Gains", abs(incomeforwinnings), res.getColor(R.color.gold));
        pieincomecategory.addItem("Autre", abs(incomeforothercategories), res.getColor(R.color.violet));
