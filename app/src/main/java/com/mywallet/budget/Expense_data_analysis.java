...
/*        final TableLayout ExpenseaccountsPieLegend = findViewById(R.id.expense_account_pie_legend);
        ...
        entriesexpense.add(new PieEntry((float) abs(expenseforcash), "Espèce"));
        ...
        entriesexpense.add(new PieEntry((float) abs(expenseforotheraccounts), "Autre"));
...
/*          pieexpenseaccount.addItem("Espèce", abs(expenseforcash), res.getColor(R.color.colorPrimaryDark));
            pieexpenseaccount.addItem("Carte de crédit", abs(expenseforcreditcard), res.getColor(R.color.colorAccent));
            pieexpenseaccount.addItem("Carte de débit", abs(expensefordebitcard), res.getColor(R.color.fab1_color));
            pieexpenseaccount.addItem("Services de paiement en ligne", abs(expenseforonlinepaymentservices), res.getColor(R.color.fab2_color));
            pieexpenseaccount.addItem("À crédit", abs(expenseforoncredit), res.getColor(R.color.blacktext));
            pieexpenseaccount.addItem("Autre accounts", abs(expenseforotheraccounts), res.getColor(R.color.dark_green));
        ...
        entriesexpensecategory.add(new PieEntry((float) abs(expenseforapparel), "vêtements"));
        entriesexpensecategory.add(new PieEntry((float) abs(expenseforeducation), "Education"));
        entriesexpensecategory.add(new PieEntry((float) abs(expenseforentertainment), "Divertissement"));
        entriesexpensecategory.add(new PieEntry((float) abs(expenseforfood), "Nourriture"));
        ...
        entriesexpensecategory.add(new PieEntry((float) abs(expenseforothercategories), "Autre"));
...
/*      pieexpensecategory.addItem("vêtements", abs(expenseforapparel), res.getColor(R.color.colorPrimaryDark));
        pieexpensecategory.addItem("Education", abs(expenseforeducation), res.getColor(R.color.colorAccent));
        pieexpensecategory.addItem("Divertissement", abs(expenseforentertainment), res.getColor(R.color.red));
        pieexpensecategory.addItem("Nourriture", abs(expenseforfood), res.getColor(R.color.fab2_color));
        pieexpensecategory.addItem("Gadgets", abs(expenseforgadgets), res.getColor(R.color.blacktext));
        pieexpensecategory.addItem("Santé et beauté", abs(expenseforhealthandbeauty), res.getColor(R.color.dark_green));
        pieexpensecategory.addItem("Développement personnel", abs(expenseforselfdevelopment), res.getColor(R.color.dark_blue));
        ...
        pieexpensecategory.addItem("Autre", abs(expenseforothercategories), res.getColor(R.color.light_blue));
