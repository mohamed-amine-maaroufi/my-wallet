...
//        final TableLayout Overall_table = findViewById(R.id.Overall_table);
        ...
        entries.add(new PieEntry((float) abs(budgetforcash), "Espèce"));
        ...
        entries.add(new PieEntry((float) abs(budgetforother), "Autre"));
...
/*      pie.addint("Espèce", abs(budgetforcash), res.getColor(R.color.colorPrimaryDark));
        pie.addint("Carte de crédit", abs(budgetforcreditcard), res.getColor(R.color.colorAccent));
        pie.addint("Carte de débit", abs(budgetfordebitcard), res.getColor(R.color.fab1_color));
        pie.addint("Services de paiement en ligne", abs(budgetforonlinepaymentservices), res.getColor(R.color.fab2_color));
        pie.addint("À crédit", abs(budgetforoncredit), res.getColor(R.color.blacktext));
        pie.addint("Autre", abs(budgetforother), res.getColor(R.color.dark_green));
