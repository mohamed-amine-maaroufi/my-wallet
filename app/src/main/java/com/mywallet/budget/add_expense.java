...
public class add_expense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.title_activity_add_expense));
        ...
        if (Objects.equals(myListPreference, "$")){
            ...
            editAmountexpense.setLocale(new Locale("fr", "TN"));
            ...
            fab2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(isCategoryInserted && isDateInserted && isAmountInserted && isAccountInserted) {
                        ...
                        Toast.makeText(add_expense.this,"Dépense ajoutée",Toast.LENGTH_LONG).show();
                        Intent intent=new Intent(add_expense.this,MainActivity.class);
                        startActivity(intent);
                    }
                    else
                        Toast.makeText(add_expense.this,"Dépense non enregistrée \nAssurez-vous que toutes les données ont été insérées",Toast.LENGTH_LONG).show();
