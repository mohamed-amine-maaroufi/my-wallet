...
//                }
                ...
                if (IsSavingInserted ) {
                    ...
                    Toast.makeText(getActivity(), "Épargne enregistrée", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(getActivity(), "Épargne non enregistrée\nAssurez-vous que l'épargne a été insérée et que vous disposez d'un budget suffisant", Toast.LENGTH_LONG).show();
                }
            }
        });
